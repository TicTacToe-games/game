...
<form method="POST"> 	  	
		<br>		  	 
	   	Х: <input type="text" name="id1" placeholder="Играч 1 id">		
	 	<p style="float: right;">
	 	O:<input type="text" name="id2" style="float: right;" placeholder="Играч 2 id"></p>	
...
<div class="alert info">
  ...
  <strong>Съобщение!</strong> Ако имате въпроси цъкнете <a style="text-decoration: none;" href="http://localhost/Tic%20Tac%20Toe/info.php"> тук</a>.
</div>
<br> <br> <br>
<footer>		   	 
    <div class="footer">
