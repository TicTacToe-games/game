...
--
-- Host: 127.0.0.1
-- Generation Time:  3 юни 2020 в 10:06
...
(1, 856616712, 'pepito@abv.bg'),
(2, 888616813, 'naslada02@abv.bg'),
(3, 889612516, 'tixa03@abv.bg'),
(4, 888462891, 'roskoto41@abv.bg'),
(5, 888616813, 'georgidim30@gmail.com'),
(6, 888458542, 'pena@abv.bg'),
(7, 888412584, 'chervenkov@abv.bg'),
(8, 884652515, 'koklcho41@abv.bg'),
(9, 856522221, 'kozito@gmail.com'),
(10, 856514212, 'vancho@gmail.com'),
(11, 855452532, 'gyshev45@abv.bg');
...
INSERT INTO `users_game` (`id`, `user1`, `user2`) VALUES
(1, 3, 1);
